    ...
    public class Platforma : MonoBehaviour
    {
        ...
        private void ActivetedPlatform()
        {
            ...
            _spriteRenderer.color =
                new Color(_spriteRenderer.color.r, _spriteRenderer.color.b, _spriteRenderer.color.g, 1f);
            _isActive = !_isActive;
        }
        ...
        private void DisActivatedPlatform()
        {
            ...
            _spriteRenderer.color = new Color(_spriteRenderer.color.r, _spriteRenderer.color.b, _spriteRenderer.color.g,
                0.3f);
        ...
        private void RotateMove()
        {
            if (_rotateInput.x != 0)
            {
                _rb.transform.Rotate(new Vector3(transform.rotation.x, transform.rotation.y,
                    transform.rotation.z - _rotateInput.x * _speedRotation) * Time.deltaTime);
            }
